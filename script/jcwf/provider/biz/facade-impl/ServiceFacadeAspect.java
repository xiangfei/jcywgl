package net.wan51.biz.service.aspect;


import net.wan51.core.service.exception.BizException;
import net.wan51.core.service.exception.ErrorEnum;
import net.wan51.core.service.exception.ServiceException;
...
public class ServiceFacadeAspect {
    ...
    @Pointcut("execution(* net.wan51.facade.*.*(..))")
