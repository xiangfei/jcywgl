package net.wan51.gateway.web.aspect;

import com.alibaba.fastjson.JSONObject;
import net.wan51.gateway.service.exception.BizException;
import net.wan51.gateway.service.exception.ErrorEnum;
import net.wan51.gateway.web.model.req.BaseReq;
import net.wan51.gateway.web.model.res.JsonResVo;
...
public class ServiceRequestAspect {
    ...
    @Pointcut("execution(public * net.wan51.gateway.web.*ontroller.*.*(..))")
